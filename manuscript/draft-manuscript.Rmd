...
There were `r label_number(1, big.mark=",")(filter(km70, treatment=="pfizer", outcome=="postest") %>% pull(cml.events))` positive SARS-CoV-2 tests,
`r label_number(1, big.mark=",")(filter(km70, treatment=="pfizer", outcome=="covidadmitted") %>% pull(cml.events))` COVID-19 hospital admissions, 
`r label_number(1, big.mark=",")(filter(km70, treatment=="pfizer", outcome=="coviddeath") %>% pull(cml.event))` COVID-19 deaths, 
and `r label_number(1, big.mark=",")(filter(km70, treatment=="pfizer", outcome=="noncoviddeath") %>% pull(cml.events))` non-COVID-19 deaths 
across `r label_number(1, big.mark=",")((filter(km70, treatment=="pfizer", outcome="coviddeath") %>% pull(cml.atrisk)) /7)` person-weeks of follow-up. 
...
#### Table 3: Estimated booster vaccine effectiveness

Effectiveness $(100 \times (1-\text{hazard ratio}))$ for the main and subgroup analyses and for all outcomes.
